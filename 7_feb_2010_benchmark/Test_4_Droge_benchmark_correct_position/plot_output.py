...
#data[:,3] = data[:,3]/aap
#subplot1.plot(data[:,2],data[:,3], color = 'black', label = 'Best connection', linewidth = 1)
...
data[:,3] = data[:,3]/aap + background
subplot1.plot(data[:,2],data[:,3], color = 'red', linestyle = '-', linewidth = 1, label = '2D, FD model solutions')
